...
class Application(tk.Tk):
    ...
    def predict(self):
        ...
        gcn_pred_var = mean_squared_error(y_dat_test, gcn_model(graph.to(device)).cpu().detach().numpy())
        rf_pred_var = mean_squared_error(y_dat_test, rf_model.predict(X_test))
...
gcn_model, gcn_test_loss = train_and_evaluate_gcn(train_data, val_data, test_data)
